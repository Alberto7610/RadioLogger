    ...
    public partial class DeviceViewModel : ObservableObject
    {
        ...
        public DeviceViewModel(AudioDevice device, AudioEngine audioEngine, ConfigManager configManager, string stationName, bool isSelected)
        {
            ...
            if (_audioEngine.IsDeviceRecording(device.Id))
            {
                ...
                // Note: The channel will be linked on the first RefreshLevels call if needed
            }
        }
        ...
        public void RefreshLevels()
        {
            ...
            {
                // In a real scenario we'd need a GetChannel, but StartRecording returns it if already active
                _activeChannel = _audioEngine.StartRecording(_device, _stationName);
            }
            ...
            {
                // RESET EVERYTHING IF NOT RECORDING
                _silenceCounter = 0;
                IsSilenceDetected = false;
                _silenceStartTime = null;
                SilenceDuration = "00:00";
